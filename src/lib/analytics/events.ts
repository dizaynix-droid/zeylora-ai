...
export const behaviorAnalyticsEvents = {
  ...
  objectRemoverPageView: "object_remover_page_view",
  objectRemoverUpload: "object_remover_upload",
  objectRemoverStarted: "object_remover_started",
  objectRemoverCompleted: "object_remover_completed",
  objectRemoverFailed: "object_remover_failed",
  firstObjectRemoverExport: "first_object_remover_export",
  backgroundReplacerUpload: "background_replacer_upload",
  backgroundReplacerStarted: "background_replacer_started",
  backgroundReplacerCompleted: "background_replacer_completed",
  backgroundReplacerFailed: "background_replacer_failed",
  firstBackgroundReplacerExport: "first_background_replacer_export",
  adCreativeUpload: "ad_creative_upload",
  adCreativeStarted: "ad_creative_started",
  adCreativeCompleted: "ad_creative_completed",
  adCreativeFailed: "ad_creative_failed",
  firstAdCreativeExport: "first_ad_creative_export",
