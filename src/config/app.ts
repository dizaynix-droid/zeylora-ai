export const appConfig = {
  ...
  shortName: "Zeylora",
  description:
    "Zeylora is an email verification, email address checker, and bulk email list cleaning platform for reducing bounce rate, protecting sender reputation, and improving deliverability.",
